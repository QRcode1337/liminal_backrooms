...
Provides a 3-level hierarchy:
  - Tier (Endpoints / SOTA / Paid / Free)
    - Provider or OmniRoute prefix (Antigravity, Codex (cx), xAI, etc.)
      - Model (Display Name (model-id), e.g., "GPT 5.6 Sol High [cx] (cx/gpt-5.6-sol-high)")
